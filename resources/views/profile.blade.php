	...
	<div class="col m12 s12 l3">
		...
		<div class="card">
			<div class="card-content" style="text-align: center;">
				<img src="{{$user->displaypic}}" class="circle responsive-img">
				<strong style="font-size: 20px">{{$user->fname}} {{$user->lname}}</strong>
			</div>
		</div>

		<ul class="hide card collapsible z-depth-4" data-collapsible="accordion">
		    <li>
